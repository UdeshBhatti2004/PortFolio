...
function LineReveal({ delay = 0 }) {
  ...
  return (
    <motion.div
      ref={ref}
      className="h-px bg-white/[0.07] w-full"
      initial={{ scaleX: 0 }}
      style={{ originX: 0 }}
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-5 sm:gap-10 lg:gap-16">
        <div className="flex sm:flex-col gap-3 sm:gap-2 items-center sm:items-start flex-shrink-0 sm:w-36 sm:pt-1">
          <div className="flex items-center gap-2">
            <span
              className="text-[9px] 2xl:text-[12px] tracking-[0.45em] uppercase text-white/20"
              style={{ fontFamily: "var(--font-outfit)" }}
            >
              {group.code}
            </span>
          ...
          <span
            className="text-white/65 text-sm 2xl:text-lg font-medium tracking-wide"
            style={{ fontFamily: "var(--font-outfit)" }}
          >
            {group.label}
          </span>
          <span
            className="hidden sm:block text-[10px] 2xl:text-[13px] text-white/20 leading-relaxed"
            style={{ fontFamily: "var(--font-outfit)" }}
          >
            {group.description}
          </span>
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, rgba(255,255,255,0.18) 40%, rgba(255,255,255,0.06) 100%)",
        }}
        initial={{ opacity: 0 }}
      ...
      >
              ...
              {["What I", "Work With."].map((line, li) => (
                <div key={li} className="overflow-hidden">
                  <motion.div
                    ...
                    style={{
                      color: li === 1 ? "rgba(255,255,255,0.18)" : "white",
                    }}
                  >
                    {line}
                  </motion.div>
        ...
        <FadeUp delay={0.4}  >
          <p
            className="text-[10px] 2xl:text-[13px] tracking-[0.35em] uppercase text-white/20 mt-5 mb-2"
            style={{ fontFamily: "var(--font-outfit)" }}
          >
            ↳ hover or tap any skill to expand
          </p>
        </FadeUp>
        ...
        <FadeUp delay={0.2} className="mt-12 sm:mt-14">
          <div className="flex items-center justify-between flex-wrap gap-3 mt-5">
            <div className="flex items-center gap-3">
              <motion.span
                className="h-1.5 w-1.5 rounded-full bg-white/45 flex-shrink-0"
