  ...
  maskImage:
    "linear-gradient(to bottom, black 0%, black 75%, transparent 100%)",
          ...
          <div className="px-5 mt-3 pb-14 z-10 flex flex-col items-center text-center">
            ...
            <motion.a
  href="#work"
  className="mt-4 flex items-center gap-2 border border-white/30 px-4 py-2.5 text-[10px] tracking-[0.3em] uppercase text-white/70 hover:bg-white hover:text-black transition-colors"
>
  View My Work ↗
</motion.a>
          </div>
  ...
  maskImage:
    "linear-gradient(to bottom, black 0%, black 85%, transparent 100%)",
          ...
          <div className="absolute bottom-12 left-10 md:left-10 z-20 max-w-sm">
            ...
            <motion.a
              href="#work"
              className="mt-6 flex items-center gap-3 border border-white/30 px-5 py-3 text-[11px] tracking-[0.35em] uppercase text-white/70 hover:bg-white hover:text-black transition-colors"
            >
              View My Work ↗
            </motion.a>
          </div>
